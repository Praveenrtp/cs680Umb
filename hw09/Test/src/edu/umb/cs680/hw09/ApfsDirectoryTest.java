...
class ApfsDirectoryTest {
	...
	@Test
	public void checkFileInDirectory() {
		assertSame("a", applications.getFiles().get(0).getName());
		assertSame("b", applications.getFiles().get(1).getName());
		assertSame("c", home.getFiles().get(0).getName());
		assertSame("d", home.getFiles().get(1).getName());
	...
	public void verifyHome() {
		String[] expected = { "root","true", "home", "0", localTime.toString(), "100", "3", "ApfsFile",localTime.toString() };
	...
	public void verifyCode() {
		String[] expected = { "home","true", "code", "0", localTime.toString(), "30", "2", "ApfsFile",localTime.toString() };
